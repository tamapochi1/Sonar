 ...
 *         : 30.09.2017 1.22 name change "g_usb_eptbl"->"g_usb_pstd_eptbl" and USBA Buffer size change.
 ***********************************************************************************************************************/
...
uint16_t g_usb_pstd_eptbl[] =
{
...
#if (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1)
    USB_BUF_SIZE(64u) | USB_BUF_NUMB(4u),               /* PIPEBUF(for USBA USE) */
#else   /* (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1) */
    USB_NULL,                                           /* PIPEBUF(for USBA USE) */
#endif  /* (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1) */
    USB_NULL, /* PIPEMAXP */
    USB_NULL, /* PIPEPERI */
    USB_NULL, /* reserve */
    ...
    (uint16_t)USB_BUF_SIZE(1024u) | USB_BUF_NUMB(8u),    /* PIPEBUF(for USBA USE) */
  #else     /* USB_CFG_DTC == USB_CFG_ENABLE */
    (uint16_t)USB_BUF_SIZE(2048u) | USB_BUF_NUMB(8u),    /* PIPEBUF(for USBA USE) */
...
#if (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1)
  #if USB_CFG_DTC == USB_CFG_ENABLE
    (uint16_t)USB_BUF_SIZE(1024u) | USB_BUF_NUMB(36u),   /* PIPEBUF(for USBA USE) */
  #else     /* USB_CFG_DTC == USB_CFG_ENABLE */
    (uint16_t)USB_BUF_SIZE(2048u) | USB_BUF_NUMB(72u),   /* PIPEBUF(for USBA USE) */
  #endif    /* USB_CFG_DTC == USB_CFG_ENABLE */
#else   /* (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1) */
    USB_NULL,                                           /* PIPEBUF(for USBA USE) */
#endif  /* (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1) */
    ...
    USB_NULL | USB_BFREOFF | USB_CFG_DBLB | USB_CFG_CNTMD | USB_CFG_SHTNAK | USB_NULL | USB_NULL, /* PIPECFG */
#if (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1)
    (uint16_t)USB_BUF_SIZE(512u) | USB_BUF_NUMB(8u), /* PIPEBUF(for USBA USE) */
#else   /* (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1) */
    USB_NULL, /* PIPEBUF(for USBA USE) */
#endif  /* (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1) */
    USB_NULL, /* PIPEMAXP */
    ...
    USB_NULL | USB_BFREOFF | USB_CFG_DBLB | USB_CFG_CNTMD | USB_CFG_SHTNAK | USB_NULL | USB_NULL, /* PIPECFG */
#if (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1)
    (uint16_t)USB_BUF_SIZE(512u) | USB_BUF_NUMB(24u), /* PIPEBUF(for USBA USE) */
#else   /* (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1) */
    USB_NULL, /* PIPEBUF(for USBA USE) */
#endif  /* (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1) */
    USB_NULL, /* PIPEMAXP */
    ...
    USB_NULL | USB_BFREOFF | USB_CFG_DBLB | USB_CFG_CNTMD | USB_CFG_SHTNAK | USB_NULL | USB_NULL, /* PIPECFG */
#if (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1)
    (uint16_t)USB_BUF_SIZE(512u) | USB_BUF_NUMB(40u), /* PIPEBUF(for USBA USE) */
#else   /* (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1) */
    USB_NULL, /* PIPEBUF(for USBA USE) */
#endif  /* (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1) */
    USB_NULL, /* PIPEMAXP */
    ...
    USB_NULL | USB_BFREOFF | USB_CFG_DBLB | USB_CFG_CNTMD | USB_CFG_SHTNAK | USB_NULL | USB_NULL, /* PIPECFG */
#if (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1)
    (uint16_t)USB_BUF_SIZE(512u) | USB_BUF_NUMB(56u), /* PIPEBUF(for USBA USE) */
#else   /* (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1) */
    USB_NULL, /* PIPEBUF(for other than USBA USE) */
#endif  /* (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1) */
    USB_NULL, /* PIPEMAXP */
    USB_NULL, /* PIPEPERI */
    USB_NULL, /* reserve */
    ...
    USB_NULL | USB_BFREOFF | USB_CFG_DBLB | USB_CFG_CNTMD | USB_CFG_SHTNAK | USB_NULL | USB_NULL, /* PIPECFG */
#if (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1)
    (uint16_t)USB_BUF_SIZE(512u) | USB_BUF_NUMB(72u), /* PIPEBUF(for USBA USE) */
#else   /* (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1) */
    USB_NULL, /* PIPEBUF(for other than USBA USE) */
#endif  /* (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) && (USB_CFG_USE_USBIP == USB_CFG_IP1) */
    USB_NULL, /* PIPEMAXP */
