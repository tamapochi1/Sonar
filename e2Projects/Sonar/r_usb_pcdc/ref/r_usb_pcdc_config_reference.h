 ...
 * USB_CFG_HCDC_BULK_IN   : Pipe number (USB_PIPE1 to USB_PIPE5)  CDC Data class Bulk In Pipe
 * USB_CFG_HCDC_BULK_OUT  : Pipe number (USB_PIPE1 to USB_PIPE5)  CDC Data class Bulk Out Pipe
 * USB_CFG_HCDC_INT_IN    : Pipe number (USB_PIPE6 to USB_PIPE9)  CDC Data class Interrupt In Pipe
 */
