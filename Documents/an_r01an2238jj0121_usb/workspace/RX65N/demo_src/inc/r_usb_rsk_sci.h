...
/* Port init */
#define SCI_TXD_PIN_SET             PORT5.PMR.BIT.B0 = 0u;      /* P50 Port mode register : peripheral io module use */\
                                    MPC.P50PFS.BYTE = 0x0a;     /* P50 Port Pin function select register : TXD2 */\
                                    PORT5.PMR.BIT.B0 = 1u;

#define SCI_RXD_PIN_SET             PORT5.PMR.BIT.B2 = 0u;      /* P52 Port mode register : peripheral io module use */\
                                    MPC.P52PFS.BYTE = 0x0a;     /* P52 Port Pin function select register : RXD2 */\
                                    PORT5.PMR.BIT.B2 = 1u;

#define SCI_TXD_PIN_CLEAR           PORT5.PMR.BIT.B0   = 0u;    /* P50 Port mode register : peripheral io module use */\
                                    SCI2.SCR.BIT.TIE   = 0u;    \
                                    SCI2.SCR.BIT.TE    = 0u;    \
                                    SCI2.SCR.BIT.TEIE  = 0u;

#define SCI_RXD_PIN_CLEAR           PORT5.PMR.BIT.B2   = 0u;    /* P52 Port mode register : peripheral io module use */\
                                    SCI2.SCR.BIT.RE    = 0;

#define SCI_TXD_PIN_RESUME          PORT5.PMR.BIT.B0   = 1u;    /* P50 Port mode register : peripheral io module use */\
                                    SCI2.SCR.BIT.TIE   = 1u;    \
                                    SCI2.SCR.BIT.TE    = 1u;    \
                                    SCI2.SCR.BIT.TEIE  = 1u;

#define SCI_RXD_PIN_RESUME          PORT5.PMR.BIT.B2   = 1u;      /* P52 Port mode register : peripheral io module use */\
                                    SCI2.SCR.BIT.RE    = 1;
