...
/* SCI DEFINE */
#define USB_PSMPL_USE_SCI           SCI_CH0
...
/* Port init */
#define SCI_TXD_PIN_SET             PORT2.PMR.BIT.B0   = 0u;    /* P20 Port mode register : peripheral io module use */\
                                    MPC.P20PFS.BYTE    = 0x0a;  /* P20 Port Pin function select register : TXD0 */\
                                    PORT2.PMR.BIT.B0   = 1u;

#define SCI_RXD_PIN_SET             PORT2.PMR.BIT.B1   = 0u;    /* P21 Port mode register : peripheral io module use */\
                                    MPC.P21PFS.BYTE    = 0x0a;  /* P21 Port Pin function select register : RXD0 */\
                                    PORT2.PMR.BIT.B1   = 1u;

#define SCI_TXD_PIN_CLEAR           PORT2.PMR.BIT.B0   = 0u;    /* P20 Port mode register : peripheral io module use */\
                                    SCI0.SCR.BIT.TIE   = 0u;    \
                                    SCI0.SCR.BIT.TE    = 0u;    \
                                    SCI0.SCR.BIT.TEIE  = 0u;

#define SCI_RXD_PIN_CLEAR           PORT2.PMR.BIT.B1   = 0u;    /* P21 Port mode register : peripheral io module use */\
                                    SCI0.SCR.BIT.RE    = 0;

#define SCI_TXD_PIN_RESUME          PORT2.PMR.BIT.B0   = 1u;    /* P20 Port mode register : peripheral io module use */\
                                    SCI0.SCR.BIT.TIE   = 1u;    \
                                    SCI0.SCR.BIT.TE    = 1u;    \
                                    SCI0.SCR.BIT.TEIE  = 1u;

#define SCI_RXD_PIN_RESUME          PORT2.PMR.BIT.B1   = 1u;      /* P21 Port mode register : peripheral io module use */\
                                    SCI0.SCR.BIT.RE    = 1;
